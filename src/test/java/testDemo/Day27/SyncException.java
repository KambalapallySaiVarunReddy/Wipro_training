...
public class SyncException {
    ...
    private static final Logger logger = LogManager.getLogger(SyncException.class);
    ...
    public void testLogin() {
        try {
            ...
            WebElement username = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ctl00_MainContent_username")));
            ...
            WebElement logoutLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ctl00_logout")));
